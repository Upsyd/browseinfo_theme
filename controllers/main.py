...
class website_browseinfo(http.Controller):
    ...
    def services(self, **post):
        ...
        return request.website.render("browseinfo_theme.services")
    ...
    def odoo(self, page=0, category=None, search='', **post):
        ...
        return request.website.render("browseinfo_theme.odoo")
    ...
    def career(self, page=0, category=None, search='', **post):
        ...
        return request.website.render("browseinfo_theme.career")
    ...
    def about(self, page=0, category=None, search='', **post):
        ...
        return request.website.render("browseinfo_theme.about")

    @http.route(['/contact'], type='http',auth="public", website=True)
    def contact(self, page=0, category=None, search='', **post):
        cr, uid, context, pool = request.cr, request.uid, request.context, request.registry

        return request.website.render("browseinfo_theme.contact")
